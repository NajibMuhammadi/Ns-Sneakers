    ...
    return (
        <div className="sidebar">
            ...
            <div className='sidebar__item'>
                <Link to='/editprofile/account' className='sidebar__item-link'>
                    <User size={32} fill='black'/>
                    <h4 className='sidebar__item-title'>Account</h4>
                </Link>
            </div>
            <div className='sidebar__item'>
                <Link to='/editprofile/email' className='sidebar__item-link'>
                    <EnvelopeSimpleOpen size={32} fill='black'/>
                    <h4 className='sidebar__item-title'>Email</h4>
                </Link>
            </div>
            <div className='sidebar__item'>
                <Link to='/editprofile/password' className='sidebar__item-link'>
